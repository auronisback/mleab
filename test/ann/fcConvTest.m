...
l = ann.layers.FcConvEquivLayer(inputShape, fN, filterShape, ...
...
expdW = zeros([fN, filterShape]);
for f = 1:fN
  expdW(f, :) = [37, 47, 67, 77, 127, 137, 157, 167] .* N;
end
expdb = sum(dZ, [1, 2, 3]);
...
% Third test: 2 channels, stride = 2, padding = 0
fprintf('Third test:\n');

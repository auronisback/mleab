...
% one output layer, using SGD as optimizer and Sum of Squared Error 
% function. The output layer is an identity activated layer.
...
net = ann.NeuralNetwork({...
  ...
  ann.layers.FcLayer(100, ds.labelShape, ann.activations.Identity)
}, errorFun);
net.print();
...
net = ann.NeuralNetwork({...
  ...
  ann.layers.FcLayer(50, ds.labelShape, ann.activations.Identity)
}, errorFun);
net.print();
